            ...
            <div class="col-sm-12">
              ...
              <h2>
								<strong class="text-primary">
									<a href=""><img src="img/sekolah.png" alt="Logo" width="30" style="position:absolute;margin-top:-8px;"> <span style="margin-left:35px;color:#fff;">PPDB Online</span></a>
								</strong>
							</h>
              </div>
            </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> SMA 99</strong></h2>
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <span style="font-size:15px">
                                 Proses PPDB Online SMA 99 hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <a href="http://www.sma99.sch.id" target="_blank">SMA 99</a> <?php echo date('Y'); ?> | IT Development</span>
              </p>
