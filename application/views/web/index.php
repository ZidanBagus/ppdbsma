...
<head>
    ...
    <title>PPDB Online | SMA 99</title>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom bxshad">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top"><img src="img/Sekolah.png" alt="Logo" width="30" style="position:absolute;margin-top:-10px;"> <span style="margin-left:35px;">PPDB Online</span> </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="#portfolio"><img src="img/sekolah.png" alt="Logo" width="15"> Tentang Sekolah</a>
                    </li>
                    <li class="page-scroll">
    ...
    <header>
      ...
      if (strtolower($this->uri->segment(1)) == 'logcs') {
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12" >
                    <img class="img-responsive" src="img/sekolah.png" style="margin-top:-15%;margin-bottom:-10px;" width="100">
                    <div class="intro-text"><br>
                        <span class="name shad" style="font-size:35px">PPDB ONLINE <br> SMA 99</span>
                      ...
                      <?php if ($web_ppdb->status_ppdb == 'buka') {?>
                        ...
                        <hr class="star-light">
												<br>
                        <!-- <h3>Login Calon Siswa Terdaftar di PPDB Online SMA 99</h3> -->
                        <span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 portfolio-item">
                    <a href="http://www.sma99.com" target="_blank" class="portfolio-link">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                        </div>
                        <img src="img/sekolah.png" class="img-thumbnail" alt=""><br><br>
                        <span class="btn btn-success btn-block">www.sma99.com</span>
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify">
                    <p>SMA 99 menyediakan PPDB secara <i>online</i> diharapkan proses PPDB dapat berjalan cepat
                    dan bisa dilakukan dimanapun dan kapanpun selama sesi PPDB Online dibuka. Proses pendaftaran calon siswa baru tidak menggunakan formulir konvensional hanya dengan mengakses website PPDB Online SMA 99. </p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="col-lg-12 text-center">
                                ...
                                <li>Calon Siswa mendaftarkan diri atau melakukan <b><a href="pendaftaran">Pendaftaran PPDB <i>online</i></a></b> melalui website <b><a href="">PPDB SMA 99</a></b>.</li>
                                <li>Setelah Calon Siswa berhasil melakukan pendaftaran, Calon siswa wajib melakukan <b>Print Out Pendaftaran & Mempersiapkan Kelengkapan Berkas PPDB SMA 99</b>.</li>
                                <li>Calon siswa datang ke SMA 99 untuk <b>VERIFIKASI</b>, membawa <b>Bukti pendaftaran & Kelengkapan Berkas PPDB SMA 99</b>. </li>
                                ...
                                <li>Jika Calon Siswa sudah mengambil <b>NOMOR TEST & Pengecekan Ruang Ujian</b> selanjutnya Calon Siswa wajib melakukan <b>TEST tertulis POTENSI AKADEMIK</b>.</li>
																<li>PENGUMUMAN HASIL PPDB Online bisa dilihat di Web PPDB SMA 99. Untuk <b>No. Pendaftaran</b> sesuaikan dengan <b>Formulir No. Pendaftaran</b> & <b>Passwordnya</b> yaitu <b>NISN</b> Calon Siswa tersebut.</li>
																<li>Jika Calon Siswa dinyatakan <b>LULUS</b> maka Calon Siswa Wajib <b>Registrasi/Daftar Ulang</b> di <b>SMA 99</b>.</li>
															</ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" style="margin-top:-100px;margin-bottom:-105px;">
                <div class="col-lg-4 text-center">
                  <br><br>
                    ...
                    <hr class="star-light">
                    <h4>
                        JL.Cendana  Desa Balamoa Kec. Pangkah Kab. Tegal Jateng, Indonesia <br><br>
                    </h4>
                    <span style="color:#222;"><b><i class="fa fa-phone-square"></i> 0856-2087-812</b> </span>
										&nbsp;
                    <span class="eml" style="color:#222;"><i class="fa fa-envelope"></i> sma99@gmail.com</span>
                    <br>
                    <a href="http://www.sma99.com/" target="_blank"><h4 class="btn btn-success">SMA 99 </h4></a>
                </div>
                <div class="col-lg-8 text-center">
                  <iframe src="" width="100%" height="465" frameborder="0" style="border:0" allowfullscreen></iframe>
              	</div>
            </div>
        <!-- </div> -->
    </section>
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; <a href="http://www.sma99.sch.id" target="_blank">SMK 99</a> <?php echo date('Y'); ?> | IT Development
                    </div>
                </div>
            </div>
        </div>
