...
<html>
  ...
  <body onload="window.print();">
    ...
    <h4 align="center" style="margin:0px;font-size:19px;"><u><b>S U R A T  P E N G U M U M A N</b></u></h4>
      <center>
        No : 420/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/PPDB.SMA99/<?php echo $thn_ppdb; ?>
      </center>

    <br>
    <table width="100%" border="0">
      <tr>
        <td colspan="3">Kepala SMA 99 Kabupaten Tegal dengan ini menyatakan bahwa :</td>
      </tr>
      <tr>
    ...
    Seleksi Sebagai Calon Peserta Didik SMA 99 tahun ajaran <?php echo $thn_ppdb; ?>/<?php echo $thn_ppdb+1; ?>.<br>
    Demikian pengumuman ini disampaikan untuk dapat digunakan sebagai mestinya.
    <br><br>

    <div style="float:right;">
      Tegal, 07 Juli <?php echo date('Y'); ?> <br>
			Kepala Sekolah,  <br>
      <br>
      <center>dto</center>
      <b><u>H. Dani arianto, S.Pd., MM.</u></b><br>
