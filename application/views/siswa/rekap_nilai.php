...
<html>
  ...
  <body onload="window.print();">
    ...
    <table width="100%" border="0" style="margin-left:5px;">
      ...
      <tr>
        <td valign="top">2.</td>
        <td align="justify">Apabila ditemukan data nilai yang telah saya berikan tidak benar, maka saya bersedia dikenakan sanksi dan atau di diskualifikasi dari seleksi Penerimaan Peserta Didik Baru (PPDB) SMA 99 Tahun Pelajaran <?php echo $thn_ppdb; ?>/<?php echo $thn_ppdb+1; ?>.</td>
      </tr>
    </table>
